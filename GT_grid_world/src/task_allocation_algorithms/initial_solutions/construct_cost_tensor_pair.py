...
def construct_cost_tensor_pair(J: Set[Tuple], Rs: AgentLoader, G: Graph, method : str = "manhattan") -> Tuple[np.ndarray, np.ndarray, List[Tuple[int, int]], List[Tuple[int, int]], Dict[int, int]]:
    """

...
from .construct_cost_elements import (
...
def fast_greedy_call(S: Stats, G: Graph, Rs: AgentLoader, J: Dict[int, Tuple], 
    ...
    (agent_start_cost_tensor, start_goal_dist, task_start_mask, task_goal_mask,
     ...
     ) = construct_cost_elements(J, Rs, G, current_time, method)

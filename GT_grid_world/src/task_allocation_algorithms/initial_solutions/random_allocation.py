...
from .construct_cost_tensor_pair import construct_cost_tensor_pair
...
def random_call(S: Stats, G: Graph, Rs: AgentLoader, J: Set[Tuple], method : str = "manhattan") -> AgentLoader:
    """

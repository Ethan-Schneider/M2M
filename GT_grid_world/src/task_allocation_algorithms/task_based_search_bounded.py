...
from ..task_allocation_algorithms.external_algorithms.task_based_search_bounded import lns

def task_based_search_bounded_fi(S : Stats, G : Graph, map_name : str, Rs : AgentLoader, J : set):
